# Well, this approach is not scalable and does not follow SOLID
# Since it is only applicable for a single or two properties
...
def person_changed(name, value):
    if name == 'can_vote':
        print(f'Voting ablitity changed to {value}')
